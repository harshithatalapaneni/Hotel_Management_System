...
public class Customerinfo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        managertable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Number", "Age", "Gender", "Country", "Allocated Room", "Time", "Deposit"
            }
        ));
        jScrollPane1.setViewportView(managertable);

        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 150, 930, 390));

        jLabel2.setBackground(new java.awt.Color(255, 255, 255));
        jLabel2.setFont(new java.awt.Font("Segoe UI Historic", 1, 24)); // NOI18N
        jLabel2.setText("Customer Details");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 50, 250, -1));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 570, 90, 40));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1210, 680));
